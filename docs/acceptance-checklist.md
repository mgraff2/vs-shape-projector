...
| U08-01 | 3 | Projector group: set Mark style to Blocks, Apply | Marks are individual inset cubes again, in the world and in the hologram; back to Faces: merged surfaces with grid lines | |
| U08-02 | 3 | Blocks style, circle radius 256, thickness 250 | The Marks line reads over 200,000 in red with the "may render slowly or stutter" warning before Apply; after Apply the figure is still drawn WHOLE (no trim line) — the warning is advisory. Switch to Faces: the same line goes white ("comfortable up to 300,000") | |
| U08-03 | 3 | Type thickness 999 on a radius 11 circle, Apply | The field keeps 256 (the config ceiling), the figure is a solid disc, nothing turns red for it; the Thickness tooltip says the figure is solid at 12 | |
| U08-04 | 3 | Server config hardMaxCubesPerProjector lowered to 5000; Blocks style, a figure of 6,000 marks | This one is trimmed and the trim line appears — the hard ceiling is the only place trimming happens | |
| U08-05 | 3 | Centre offset 30, 0 with the model on | The model is scanned around the figure's centre (30 east of the projector) and the miniature is framed on that centre | |
| U08-06 | 3 | Model on beside a busy area (animals, growing grass, snow); watch the miniature for a minute | It updates no more than about every three seconds, does not shimmer, and a plain Apply on a figure does not rescan the land (instant) | |
| U08-07 | 3 | Hover every control | Each tooltip is one or two short sentences | |
| U08-08 | 3 | Follow-terrain circle, radius 256, thickness 250 (≈250k columns); walk and turn around it for a minute | No periodic stall; the water re-check is spread over ticks. Pour water under part of it: that part moves up within ~30 s | |
| U08-09 | 3 | Radius 256, thickness 250, Faces; look at the miniature from all sides and at the world disc from a low angle | No view-dependent stall; the miniature shows surface outlines, not a per-cell grid; the world disc shows outlines only (a radius 60 disc still shows the full grid) | |
| U08-10 | 3 | Freeze updates ON, Apply; dig under a draped layer, place blocks in the model box, fill a feedback cell | Nothing changes until Freeze is switched OFF and applied, then everything catches up at once | |
